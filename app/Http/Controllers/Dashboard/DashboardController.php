...
class DashboardController extends Controller
{
    public function viewDashboard(){
        ...
        return view('dashboard.dashboard')->with(['total_services' => $total_services, 'total_blogs' => $total_blogs, 'total_candidates' => $total_candidates, 'total_products' => $total_products  ]);
    }
}
